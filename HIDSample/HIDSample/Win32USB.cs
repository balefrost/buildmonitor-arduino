...
namespace HIDSample
{
    ...
    public class Win32Usb
    {
        ...
        public static extern bool SetupDiGetDeviceInterfaceDetail(IntPtr lpDeviceInfoSet,
                                                                     ...
                                                                     ref uint nRequiredSize, IntPtr lpDeviceInfoData);
        ...
        public static extern SafeFileHandle CreateFile([MarshalAs(UnmanagedType.LPStr)] string strName, uint nAccess,
                                                  uint nShareMode, IntPtr lpSecurity, uint nCreationFlags,
                                                  uint nAttributes, IntPtr lpTemplate);
